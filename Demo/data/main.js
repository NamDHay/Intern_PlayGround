...
//global
var gateway = `ws://192.168.1.28/ws`;
var websocket;
var IsConnect;
var Flagfile;
...
function generationCard(jsonValue){
  var data = JSON.parse(jsonValue);
  var TableHTML="";
  TableHTML = "<table class=\"table table-borderless \"><thead class=\"thead-dark\"><th>NumberValues</th><th>Value</th><th>Select Reg</th></thead><tbody>";
  var values = document.getElementById('values').value;
  for(var i = 0; i < values; i++){
    var select = "<select id=\"selectvalue\" value=\"0\" class=\"state\"><option value=\"0\" selected=\"\">0</option><option value=\"1\">1</option><option value=\"2\">2</option><option value=\"3\">3</option><option value=\"4\">4</option><option value=\"5\">5</option><option value=\"6\">6</option><option value=\"7\">7</option><option value=\"8\">8</option><option value=\"9\">9</option><option value=\"10\">10</option></select>";
    // var selectvalue = document.getElementById('selectvalue').value;
    // for(var j = 0; j < data.Data.length;j++){
    //   if(selectvalue == data.Data[j].address)
    //     var value[i] = data.Data[j].value;
    // }
    TableHTML += "<tr><td>"+"Value "+i+"</td><td>"+"value"+"</td><td>"+select+"</td></tr>";
  }
  TableHTML += "</tbody></table>";
...
function AddCardBody(){
  html+="<div class='cardcuatao'>\
        <Center>\
          <h2><span id=\"namecard1\">"+namecard+"</span> </h2>\
          ...
          <div class=\"container overflow-hidden text-center\">\
            <div class=\"row gy-5\">\
              ...
              <div class=\"col-5\">\
                <div class=\"state\" id=\"card1-value1\">"+ value1 +"</div>\
              </div>\
              <div class=\"col-4\">\
                <div class=\"state\">Value 2:</div>\
              </div>\
              <div class=\"col-5\">\
                <div class=\"state\" id=\"card1-value2\">"+ value2 +"</div>\
              </div>\
              <div class=\"col-4\">\
                <div class=\"state\">Value 3:</div>\
              </div>\
              <div class=\"col-5\">\
                <div class=\"state\" id=\"card1-value3\">"+ value3 +"</div>\
              </div>\
              <div class=\"col-4\">\
                <div class=\"state\">Value 4:</div>\
              </div>\
              <div class=\"col-5\">\
                <div class=\"state\" id=\"card1-value4\">"+ value4 +"</div>\
              </div>\
              <div class=\"col-4\">\
                <div class=\"state\">Value 5:</div>\
              </div>\
              <div class=\"col-5\">\
                <div class=\"state\" id=\"card1-value5\">"+ value5 +"</div>\
              </div>\
            </div>\
        </Center>\
      </div>\
...
function SaveCard(){
  ...
  appData[preID] = AppID+","+poss+","+app+","+nodeID+","+netID +","+namecard+","+value1+","+value2+","+value3+","+value4+","+value5;
  jsonApp = "{\"Application\":[{\"app\":\""+appData[0]+"\"}\n";
  if(AppID >0){
    for(var k = 1; k<preID+1;k++){
...
// function updateCard(){
//   var namecard = document.getElementById("input_namecard").value;
//   appData[AppID] = AppID+","+poss+","+app+","+nodeID+","+netID +","+namecard+","+value1+","+value2+","+value3+","+value4+","+value5;
//   // jsonApp = "{\"Application\":[{\"app\":\""+appData[0]+"\"}\n";
//   // if(AppID >0){
