...
var jsontable = "";// data tu mod gui len
var AppID = 0;
var appData = [];
var valuetable = [];
var addresstbale = [];
...
const select  = document.getElementById("staticip");
// select mode wifi
select.addEventListener('change', function handChange(event) {
...
function onLoad(event) {
  ...
  document.getElementById("datawritemodbus").value ="{\"Command\":\"editModbusData\",\"writeReg\":[]}"; 
...
function UnlockStaff() {
  ...
  var ids = ['dashboard', 'settingA', 'features', 'board', 'openbuttonchange', 'name_product','wifimode','settingBtnKL','settingBtnEX'];
...
function UnlockAdmin() {
  ...
  var ids = ['dashboard', 'settingA', 'features', 'board', 'application', 'console', 'advanced', 'wifi', 'rf', 'ethernet', 'modbus', 'zicon', 'openbuttonchange', 'name_product','wifimode','settingBtnKL','settingBtnEX'];
  ids.forEach(function (id) {
    var element = document.getElementById(id);
    if (element) {
      if (unlockValue == 2) {
...
function LogOut() {
  ...
  var ids = ['dashboard', 'settingA', 'features', 'board', 'application', 'console', 'advanced', 'wifi', 'rf', 'ethernet', 'modbus', 'zicon', 'openbuttonchange', 'changePassA', 'name_product','wifimode','settingBtnKL','settingBtnEX'];
  ids.forEach(function (id) {
    var element = document.getElementById(id);
    if (element) {
...
function loadtable(jsonValue) {
  var TableHTML = "";
  TableHTML = "<table class=\"table table-borderless \"><thead class=\"thead-dark\"><th>STT</th><th>Slave ID</th><th>Address</th><th>Type Data</th><th>Data</th></thead><tbody>";
  ...
  for (var i = 0; i < TableDataLen; i++) {
    ...
    TableHTML += "<tr><td>" + stt + "</td><td>" + id + "</td><td id=\"addresstable"+i+"\"></td><td>" + type + "</td><td id=\"valuetable"+i+"\"></td></tr>";
  }
  
  TableHTML += "</tbody></table></br>";
  document.getElementById("TableData").innerHTML = TableHTML;
  for(var i = 0; i < keys.Data.length; i++) {
    addresstbale[i] = document.getElementById("addresstable"+ i).innerHTML = keys.Data[i].address;
  }
}
function loadDataTable(jsonValue){
  var keys = JSON.parse(jsonValue);
  for(var i = 0; i < keys.Data.length; i++) {
    valuetable[i] = document.getElementById("valuetable"+ i).innerHTML = keys.Data[i].value;
  }
}
...
function updatevalue(){
  ...
  for (var i = 0; i < appLen; i++) {
    ...
    document.getElementById("card"+i+"value1").innerHTML = jsonTasbleObj.Data[value1].value;
    document.getElementById("card"+i+"value2").innerHTML = jsonTasbleObj.Data[value2].value;
    document.getElementById("card"+i+"value3").innerHTML = jsonTasbleObj.Data[value3].value;
...
function changeRegOptions(){
  ...
  for(var k = 1; k < 7; k++) {
    ...
    for(var i=0; i<addresstbale.length; i++){
...
function addvaluecard(jsonValue){
  ...
  for(var i = 0; i < keys.Data.length;i++){
    ...
    if(selectvalue6 == keys.Data[i].address){
      document.getElementById("value6").innerHTML = keys.Data[i].value;
    }
  }
}
//Save add card
