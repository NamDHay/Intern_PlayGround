...
function onMessage(event) {
  ...
  //   var jsonTotalSlave = document.getElementById('dataslave').value = event.data; 
  //   loadBoardSlave(jsonTotalSlave);
...
function saveCard(){
  ...
  websocket.send(document.getElementById('jsonApp').value);
}
function saveTableID(){
  websocket.send(document.getElementById('datatableid').value);
}
function savedataproduct(){
  websocket.send(document.getElementById('dataslave').value);
}
function saveslave(){
  websocket.send(document.getElementById('dataslave').value);
}
